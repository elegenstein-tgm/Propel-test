...
class PersonTableMap extends TableMap
{
     ...
     */
    const COL_PERSONNAME = 'person.personName';

    /**
     * the column name for the beschreibung field
     */
    const COL_BESCHREIBUNG = 'person.beschreibung';
     ...
     */
    const COL_CREATED_AT = 'person.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'person.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Personname', 'Beschreibung', 'PersonId', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('personname', 'beschreibung', 'personId', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(PersonTableMap::COL_PERSONNAME, PersonTableMap::COL_BESCHREIBUNG, PersonTableMap::COL_PERSON_ID, PersonTableMap::COL_CREATED_AT, PersonTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('personName', 'beschreibung', 'person_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Personname' => 0, 'Beschreibung' => 1, 'PersonId' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('personname' => 0, 'beschreibung' => 1, 'personId' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(PersonTableMap::COL_PERSONNAME => 0, PersonTableMap::COL_BESCHREIBUNG => 1, PersonTableMap::COL_PERSON_ID => 2, PersonTableMap::COL_CREATED_AT => 3, PersonTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('personName' => 0, 'beschreibung' => 1, 'person_id' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addColumn('personName', 'Personname', 'VARCHAR', false, 32, null);
        $this->addColumn('beschreibung', 'Beschreibung', 'VARCHAR', false, 100, null);
    ...
    {
        $this->addRelation('notizen', '\\Notiz', RelationMap::ONE_TO_MANY, array('person_id' => 'fk_id', ), null, null, 'notizens');
        $this->addRelation('notizen', '\\Teilnehmen', RelationMap::ONE_TO_MANY, array('person_id' => 'pid', ), null, null, 'notizens');
    } // buildRelations()
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 2 + $offset : static::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return (string) $row[TableMap::TYPE_NUM == $indexType ? 2 + $offset : static::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PersonTableMap::COL_PERSONNAME);
            $criteria->addSelectColumn(PersonTableMap::COL_BESCHREIBUNG);
            $criteria->addSelectColumn(PersonTableMap::COL_PERSON_ID);
            $criteria->addSelectColumn(PersonTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(PersonTableMap::COL_UPDATED_AT);
        } else {
