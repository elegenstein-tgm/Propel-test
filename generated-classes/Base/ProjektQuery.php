 ...
 * @method     ChildProjektQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     ChildProjektQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method     ChildProjektQuery groupByCreatedAt() Group by the created_at column
 * @method     ChildProjektQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method     ChildProjekt findOneByCreatedAt(string $created_at) Return the first ChildProjekt filtered by the created_at column
 * @method     ChildProjekt findOneByUpdatedAt(string $updated_at) Return the first ChildProjekt filtered by the updated_at column
 *
 ...
 * @method     ChildProjekt[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildProjekt objects filtered by the created_at column
 * @method     ChildProjekt[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildProjekt objects filtered by the updated_at column
...
abstract class ProjektQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT projektname, startdate, enddate, projekt_id, created_at, updated_at FROM projekt WHERE projekt_id = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(ProjektTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(ProjektTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjektTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(ProjektTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(ProjektTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjektTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(ProjektTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ProjektTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(ProjektTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ProjektTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(ProjektTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(ProjektTableMap::COL_CREATED_AT);
    }
